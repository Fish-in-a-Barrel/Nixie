...
/// @param code The ASCII code of the character to draw.
void OLED_DrawCharacter(uint8_t row, uint8_t col, uint8_t code);

/// Draws a single character to the display, inverted.
///
/// @param row The row offset of the character.
/// @param col The column offset of the character.
/// @param code The ASCII code of the character to draw.
...
/// Draws a string of characters to the display, inverted.
///
/// @param row The row offset of the first character.
/// @param col The column offset of first the character.
/// @param str The ASCII code of the character to draw.
